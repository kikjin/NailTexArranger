...
1. Prepare a YAML file to define where each nail textures should be placed. you can use `generate_assignment_settings.py` for that.

1. Run `arrange_images.py` to arrange cropped nail textures to your avatar's body texture.
